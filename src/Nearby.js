      ...
      <header className="p-6 bg-white flex flex-col items-center" style={{ backgroundColor: "#012E3F" }}>      
        ...
        {userLocation ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
            {nearbyBathrooms.slice(0, 9).map((bathroom) => ( // แสดงแค่ 9 ที่ใกล้ที่สุด (3 รายการต่อบรรทัด)
              <div key={bathroom.id} className="bg-gray-900 shadow-2xl rounded-lg overflow-hidden transform transition duration-500 hover:scale-105">
                ...
                <div className="p-6 flex flex-col justify-between h-64">
                  ...
                  <div>
                    ...
                    <Link 
                      ...
                      className="mt-4 py-2 px-4 rounded-lg" style={{ backgroundColor: "#F7F1F0", color: "#09090b" }}
                    > ดูรายละเอียด</Link>
                  </div>
                </div>
              </div>
